...
/**
   ...
   Modified for sword by Ricardo Leon Chavez
    for CS56, F17, UCSB
*/
public class IronThrone extends Sword implements Shape
{
    /**
     * Constructor for objects of class CoffeeCup
     */
    public IronThrone(double x, double y, double width, double height)
    {
	...
	// | +--+ +--+ +--+ |
	// |w 2w w 2w w w2 w|
	//instead of windows i will be multiplying the swords
	// as well as rotating them and arranging them to
	//look somewhat like a chair
