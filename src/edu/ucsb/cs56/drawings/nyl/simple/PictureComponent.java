package edu.ucsb.cs56.drawings.nyl.simple;
...
/**
   ...
   @author Nery Yaritza Lara Mancia (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("My completed snowman! Nery Yaritza Lara Mancia", 20,20);
