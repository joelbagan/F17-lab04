package edu.ucsb.cs56.drawings.drew_polk.simple;
...
/**
   ...
   @author Andrew Polk (fixed the snowmans's head)
...
{  
    ...
    {  
        ...
        g2.drawString("This snowman now has a head by Andrew Polk", 20,20);
