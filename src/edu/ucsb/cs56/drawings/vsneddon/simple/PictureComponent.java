package edu.ucsb.cs56.drawings.vsneddon.simple;
...
/**
   ...
   @author Victoria Sneddon (fixed the snowmans's head)
...
{  
	...
	Circle snowManTopCircle =
	   new Circle
	    (
	     snowManCenterBottomX,
	     snowManCenterBottomY - middleRadius * 4.6 - topRadius,
	     topRadius
	     );
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("Victoria Sneddon added a snowman head", 20,20);
